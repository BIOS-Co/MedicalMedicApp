...
export default function Login(props) {
  ...
  */
  ...
  let {
    userData,
    setUserData, // VARIABLE PARA ALMACENAR DATOS DEL USUARIO
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View
            style={{ ...styles.InputsDesignContainer, ...Globalstyles.Purple }}
          >
            <Input
              inputContainerStyle={{
          ...
          >
            <TouchableOpacity
              ...
              disabled={valid}
            >
              <Text style={{ ...styles.buttonText, ...Globalstyles.Medium }}>
                Ingresar
              </Text>
            </TouchableOpacity>
